<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="admin_master.php"><i class="fa fa-dashboard fa-fw"></i> NFooD</a>
            </li>
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Admin Info <span class="fa arrow"></span></a>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="manage_sub_category.php"> Manage Sub Category </a>
                    </li>
                </ul>
            </li>
            </li>
            ...
            <li>
                <a href="manage_order.php"><i class="fa fa-table fa-fw"></i> Manage Order</a>
            </li>
            <li>
