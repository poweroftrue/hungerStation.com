...
if (isset($_POST['btn'])) {
    $message = $obj_sub_category->save_sub_category_info($_POST);
}
?>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading page-header text-center lead">
                <u class="text-success">Add Sub Category Information</u><br/>
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <textarea name="sub_category_description" class="form-control" rows="6"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-3 col-lg-9">
                            <input type="submit" name="btn" value="Save Sub Category Info" class="btn btn-primary btn-block">
                        </div>
                    </div>
                </form>
            </div>
