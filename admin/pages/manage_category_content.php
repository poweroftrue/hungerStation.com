    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading page-header text-center lead">
                <u class="text-success">Manage Category Information</u><br/>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    <?php if ($category_info['publication_status'] == 1) { ?>
                                        <a href="?status=unpublished&&id=<?php echo $category_info['category_id']; ?>" class="btn btn-danger" title="Unpublished">
                                            <span class="glyphicon glyphicon-arrow-down"></span>
                                        </a>
                                    <?php } else { ?>
                                        <a href="?status=published&&id=<?php echo $category_info['category_id']; ?>" class="btn btn-primary" title="Published">
