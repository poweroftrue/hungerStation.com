    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading page-header text-center lead">
                <u class="text-success">Manage Product Information</u><br/>
                    ...
                    <tbody>
                        ...
                        while ($all_product = mysqli_fetch_assoc($query_result)) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><?php echo $all_product['sub_category_name']; ?></td>
                                ...
                                <td class="center">
                                    ...
                                    <?php if ($all_product['publication_status'] == 1) { ?>
                                        <a href="?status=unpublished&&id=<?php echo $all_product['product_id']; ?>" class="btn btn-danger" title="Unpublished">
                                            <span class="glyphicon glyphicon-arrow-down"></span>
                                        </a>
                                    <?php } else { ?>
                                        <a href="?status=published&&id=<?php echo $all_product['product_id']; ?>" class="btn btn-primary" title="Published">
