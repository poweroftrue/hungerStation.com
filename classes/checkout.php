...
class Checkout extends Db_Connect {
    ...
    public function save_order_info($data) {
        ...
        if ($payment_type == 'cash_on_delivery') {
            ...
            echo 'Please call +880 1611 78 78 08 for bKash payment or choose Cash On Delivery.';
            exit();
        } 
        else if ($payment_type == 'rocket') {
            echo 'Please call +880 1611 78 78 08 for Rocket payment or choose Cash On Delivery.';
            exit();
        }
    }
