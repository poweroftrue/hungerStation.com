...
<html lang="en">
    ...
    <body>
        ...
        if (isset($pages)) {
            ...
            } else if ($pages == 'foods_menu') {
                include './pages/foods_menu_content.php';
            } else if ($pages == 'sub_category') {
            ...
            } else if ($pages == 'journal') {
                include './pages/journal_content.php';
            }
        } else {
