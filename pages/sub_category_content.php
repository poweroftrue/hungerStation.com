...
$sub_category_query_result_by_id = $obj_app->select_product_info_by_sub_category_id($sub_category_id);
$sub_category_product_info_by_id = mysqli_fetch_assoc($sub_category_query_result_by_id);

$sub_category_query_result = $obj_app->select_all_published_sub_category_info();
?>


<section class="foods_menu_top_area" style="background: url(assets/<?php echo $sub_category_product_info_by_id['product_image']; ?>) no-repeat scroll center center / cover  rgba(0, 0, 0, 0);">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="bread_top_box">
                    <h2><?php echo $sub_category_product_info_by_id['sub_category_name']; ?></h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="bread_box">
                    <ul class="breadcumb">
                        ...
                        <li><a href="foods_menu.php">Menu <span>|</span></a></li>
                        <li class="active" ><a  href="sub_category.php?id=<?php echo $sub_category_product_info_by_id['sub_category_id']; ?>"><?php echo $sub_category_product_info_by_id['sub_category_name']; ?> </a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8 col-xs-12">
                <div class="main_category_right">
                    <div class="row">
                        <?php
                        while ($sub_category_product_info_by_id = mysqli_fetch_assoc($sub_category_query_result_by_id)) {
                            extract($sub_category_product_info_by_id);
                            ?>
